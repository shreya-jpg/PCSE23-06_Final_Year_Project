...
class Application:
    ...
    def __init__(self):
        ...
        self.panel.place(x=40, y=3, width=400, height=600)

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=500, y=115, width=400, height=400)
        ...
        label1.image = test
        label1.place(x=930,y=110)

        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=250, y=550)

        self.T1 = tk.Label(self.root)
        self.T1.place(x=10, y=550)
